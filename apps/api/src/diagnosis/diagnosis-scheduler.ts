...
import type { DiagnosisCycleRunner } from "./diagnosis-coordinator";

export class DiagnosisScheduler {
  ...
  public constructor(
    private readonly runner: DiagnosisCycleRunner,
  ...
  private async runOnce(): Promise<void> {
    try {
      ...
      this.logger.error(
        ...
        "Diagnosis scheduler cycle failed"
      );
    } finally {
